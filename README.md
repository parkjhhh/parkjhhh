...
|----|---------------|------|-----------|----------|------|------|
| 1  | **서울시 공원 데이터 CRUD** | JDBC를 통해 STS와 MySQL DB를 연결시켜 CRUD 기능 구현 | Java, DBeaver, MySQL| &nbsp;&nbsp;👨‍👨‍👦‍👦<br>(4명)| [GitHub 링크](https://github.com/ChoiYoungHa/WooriFISA-java-stream-refactoring) | 2024-07-19 |
